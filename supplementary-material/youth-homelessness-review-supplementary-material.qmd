...
required_packages <- c(
  ...
  "readxl",
  "esc")
groundhog.library(required_packages, "2024-12-01")
```
...
-   [*PRISMA 2020 Checklist*](#sec-prisma-checklist) --- includes details of how this review meets the PRISMA 2020 reporting guidelines

[**Supplementary methodology:**](#sec-methodology})

-   [*Selection criteria*](#sec-inclusion-exclusion) —- includes details of the criteria used to select studies eligible for inclusion in this review

-   [*Search methods*](#sec-search-methods) --- includes search strategies and results for each published database and grey sources

-   [*Data collection*](#sec-data-collection) --- includes the process used to screen titles and abstracts and full-texts

-   [*Data extraction*](#sec-data-extraction) --- includes the template and information extracted from each included study used to transform into a common effect size

-   [*Effect size transformation*](#sec-es-transformation) --- includes detailed description of the methods used to transform reported results into a common effect size

-   [*Defining Housing First components*](#sec-hf-components-definitions) --- includes definitions of Housing First components used in this review

-   [*Deviations from the protocol*](#sec-deviations) --- details how our review deviated from the registered protocol

[**Supplementary results:**](#sec-results)

-   [*Secondary reports of included studies*](#sec-secondary-reports) --- details additional reports of included studies 

-   [*Studies excluded at full text review*](#sec-excluded-studies) --- details of studies excluded at full text review with reasons for exclusion

-   [*Housing First components of included interventions*](#sec-hf-components) --- includes details of how the components of each included intervention map on to Housing First components

-   [*Instruments used in included studies*](#sec-instruments) --- includes details of the instruments used to assess outcomes for participants in included studies

-   [*Risk of bias in included studies*](#sec-risk-of-bias) --- includes the template and assessments used to assess the risk of bias in included studies

-   [*Barriers and Facilitators*](#sec-barriers-facilitators) --- includes additional details on the barriers and facilitators affecting implementation identified in included studies
...
## PRISMA 2020 checklist {#sec-prisma-checklist}
...
prisma_table |>
  ...
  pack_rows(
    index = c(
      ...
      "Discussion" = 3,
      "Other Information" = 6),
    label_row_css = "text-align: left; color: #FFFFFF; background-color: #E06632;"
    ) |>
  unclass() |> 
  cat()
```
...
## Selection criteria {#sec-inclusion-exclusion}

The population of interest was youth aged between 16 and 25 who are currently, or have previously, experienced homelessness; have substantial socio-emotional issues that require services beyond housing; and/or are members of a demographic group known to be facing additional barriers, such as adolescent parents, those who identify as First Nations, or have a mental health condition. 

Interventions of interest included those that combine the provision of accommodation, either directly or indirectly (i.e., through vouchers), with additional support services such as case management, counselling, independent living or life skills development, transportation assistance, employment skills training and/or coaching, support to engage or re-engage in education, residential advisors, and personalised advice or mentoring. 

Comparators included treatment as usual, another intervention, no intervention, or waitlist control. Primary outcome domains were stable housing, health, social and emotional wellbeing, education, employment and earnings. Secondary outcomes domains were legal and justice, independent living skills, and social connections. 

Both randomised and non-randomised study designs that used causal methods to assess the impact of the intervention were eligible for inclusion. Specifically, a non-randomised study needed to use a counterfactual approach that estimated the impact of the intervention by comparing observed participant outcomes with hypothetical non-participant outcomes. 

Inclusion and exclusion criteria by used in this review by PICOSS domain are detailed in @tbl-yh-review-picoss.

+----------------+---------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| Domain         | Inclusion criteria                                                                                                                    | Exclusion criteria                                                                                                       |
+================+=======================================================================================================================================+==========================================================================================================================+
| *Population*   | Youth aged 16-25 who:                                                                                                                 | Studies where more than 80% of the population do not meet inclusion criteria e.g., individuals aged under 16 or over 25. |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Are currently, or have previously, experienced homelessness; and                                                                  |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Have substantial socio-emotional issues that require services beyond housing, such as:                                            |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                |     -   Have current or prior mental health issues (either self-reported or diagnosed)                                                |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                |     -   Prior involvement with child protection or out-of-home care system                                                            |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                |     -   Have prior involvement with the juvenile or adult justice system                                                              |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                |     -   Have a history of family violence, as victims or perpretrators                                                                |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                |     -   Have current or prior problem use of alcohol and other drugs (either self-reported or diagnosed)                              |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                |     -   Have a physical or intellectual disability                                                                                    |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                |     -   Received public assistance payments; and/or                                                                                   |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Are a member of a demographic group known to be facing additional barriers, including:                                            |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                |     -   Adolescent parents                                                                                                            |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
...
|                |     -   Identify as LGBTIQ+                                                                                                           |                                                                                                                          |
+----------------+---------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| *Intervention* | Interventions that combine the provision of accommodation — either directly or indirectly — with additional support services such as: | Studies examining other interventions                                                                                    |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Case management                                                                                                                   |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Counselling, mental health or psychological assistance                                                                            |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Independent living or life skills development                                                                                     |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Transportation assistance                                                                                                         |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Employment skills training and/or coaching                                                                                        |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Support to engage or re-engage in education                                                                                       |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Residential advisors                                                                                                              |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Personalised advice or mentoring                                                                                                  |                                                                                                                          |
+----------------+---------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| *Comparison*   | Treatment as usual, another intervention, no intervention, or waitlist control                                                        | Studies using other comparators                                                                                          |
+----------------+---------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| *Outcome*      | Studies that report outcomes within the following domains:                                                                            | Studies that report other outcomes                                                                                       |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Stable housing                                                                                                                    |                                                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Health                                                                                                                            |                                                                                                                          |
...
|                | -   Social connections                                                                                                                |                                                                                                                          |
+----------------+---------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| *Setting*      | High income countries as defined by the World Bank in FY2022-23                                                                       | Countries defined as low and middle income by the World Bank in FY2022-23                                                |
+----------------+---------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------+
| *Study design* | Randomised controlled trials (RCT) including:                                                                                         | Non-primary studies, including:                                                                                          |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Individual RCTs                                                                                                                   | -   Literature reviews                                                                                                   |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Cluster RCTs                                                                                                                      | -   Systematic reviews                                                                                                   |
|                |                                                                                                                                       |                                                                                                                          |
|                | Step-Wedge designs with random time allocation                                                                                        | -   Meta-analysis                                                                                                        |
|                |                                                                                                                                       |                                                                                                                          |
|                | Non-randomised designs that use parallel cohorts that adjust for baseline equivalence:                                                | Studies without a valid counterfactual, including:                                                                       |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Covariate matching                                                                                                                | -   Single group pre-post designs                                                                                        |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Propensity score based methods                                                                                                    | -   Control group designs without matching in time and establishing baseline equivalence                                 |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Doubly robust methods                                                                                                             | -   Cross-sectional designs                                                                                              |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Instrumental variable estimation                                                                                                  | -   Non-controlled observational (cohort) designs                                                                        |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Difference-in-Difference estimation                                                                                               | -   Case-control designs                                                                                                 |
|                |                                                                                                                                       |                                                                                                                          |
|                | -   Interrupted time-series                                                                                                           | -   Case studies/series                                                                                                  |
|                |                                                                                                                                       |                                                                                                                          |
...
: Inclusion and exclusion criteria by PICOSS domain {#tbl-yh-review-picoss} {tbl-colwidths="\[15,45,45\]"}

## Search methods {#sec-search-methods}

Our search strategy encompassed 10 electronic databases (Cochrane Central Register of Trials via Ovid, CINAHL via EBSCO, EMBASE via Ovid, ERIC via ProQuest, PsycINFO via Ovid, MEDLINE via Ovid, Sociological Abstracts via ProQuest, Social Services Abstracts via ProQuest, Criminal Justice Abstracts via EBSCO, Violence and Abuse Abstracts via EBSCO) with no year of publication or language restrictions. Our strategy for identifying grey literature comprised searching six clearinghouses, government agencies and organisations known to be undertaking or consolidating research in this area (Australian Housing and Urban Research Institute (AHURI), Analysis and Policy Observatory database (APO), Australian Criminology Database (CINCH), Australian Family and Society Abstracts database (AIFS), Chapin Hall at the University of Chicago and the Washington State for Public Policy). Reference lists of included studies were reviewed as were studies included in reviews by @altena2010effectiveinterventionshomeless, @wang2019impactinterventionsyouth and @morton2020interventionsyouthhomelessness.

Barriers and facilitators to implementation are not typically reported at length in the results of published RCTs or NRSs. We expanded our search to review additional reports of included studies in order to identify them. These included: study protocols, conference presentations, technical reports and process/implementation evaluations. 

Additional reports of the same study were identified by a) reviewing reference lists of included studies, b) reviewing the RCT registry records of included studies, c) reviewing additional publications by the authors of included studies. 
...
Covidence [@veritashealthinnovationcovidencesystematicreview], and Zotero [@corporationfordigitalscholarship2022zotero] were used for deduplication, literature screening, and library storage/referencing, respectively.

Two reviewers (DT and SV) independently screened each title/abstract identified by the search strategy, with a third reviewer resolving any disagreements (AS and SB). Studies deemed potentially relevant during title/abstract screening underwent full-text assessment by two independent reviewers (DT and SV) using the inclusion and exclusion criteria outlined in the protocol [@taylor2023protocolsystematicreview]. Discrepancies were resolved through discussion with an additional reviewer (SB and AS). 
...
All reported measures corresponding to outcomes of interest at all available time points were extracted into a shared spreadsheet which is available in @tbl-yh-instruments.

### Data extraction template: study-level data
...
### Data extraction template: Outcome-level data
...
### Analytic Code Implementation {#sec-code-implementation}
...
## Defining Housing First components {#sec-hf-components-definitions}

Components of interventions were classified based up on the definitions in @tbl-yh-hf-components-def.

```{r}
#| echo: false
#| results: asis
#| tbl-cap: Definitions of Housing First components for youth
#| name: yh-supplementary-material-hf-components-definitions
#| label: tbl-yh-hf-components-def
 
# read data
components_definitions_file_location <- "./inputs/housing_first_definitions.xlsx"
components_definitions_table <- readxl::read_excel(
  components_definitions_file_location,
  sheet = "definitions")

# produce table
components_definitions_table |>
  kbl(
    format = "html"
    ) |>
  kable_styling(
  ...
  pack_rows(
    index = c(
      "Housing-related components" = 7, 
      "Support services components" = 6, 
      "Components applicable to both housing and support services" = 3),
    label_row_css = "text-align: left; color: #FFFFFF; background-color: #E06632;"
    ) |>
  column_spec(
    1, bold = T) |>
...
## Deviations from the protocol {#sec-deviations}

We did not pre-specify that we would explore barriers and facilitators encountered during the implementation of included interventions. The decision to undertake this was made during the course of the review when it became evident that we had identified insufficient studies to undertake a quantitative synthesis.

# Supplementary Results {#sec-results}

## Secondary reports of included studies {#sec-secondary-reports}

Additional reports of included studies, including protocols, implementation evaluations, and conference presentations, are detailed in @tbl-yh-reports-included-studies.

```{r}
#| echo: false
#| results: asis
#| tbl-cap: Distinguishing between reports of included studies
#| name: yh-supplementary-material-reports-included-studies
#| label: tbl-yh-reports-included-studies
 
# read data
reports_included_studies_file_location <- "./inputs/included_studies.xlsx"
reports_included_studies_table <- readxl::read_excel(
  reports_included_studies_file_location,
  sheet = "reports")

# produce table
reports_included_studies_table |>
  mutate(
    `Primary Reference` = str_c("@", `Primary Reference`),
    `Secondary Reference` = str_c("@", `Secondary Reference`),
    ) |>
  kbl(
    format = "html"
    ) |>
...
## Studies excluded at full text review {#sec-excluded-studies}

Studies excluded at full-text review stage are detailed in @tbl-yh-reports-excluded-studies, with a reason and rationale for their exclusion.

```{r}
#| echo: false
#| results: asis
#| tbl-cap: Studies excluded at full-text review
#| name: yh-supplementary-material-reports-excluded-studies
#| label: tbl-yh-reports-excluded-studies
 
# read data
excluded_studies_file_location <- "./inputs/excluded_studies.xlsx"
excluded_studies_table <- readxl::read_excel(
...
## Housing First components of included interventions {#sec-hf-components}

Details of Housing First components in included studies are detailed in @tbl-yh-hf-components.

```{r}
#| echo: false
#| results: asis
#| tbl-cap: Details of Housing First components in included studies
#| name: yh-supplementary-material-hf-components
#| label: tbl-yh-hf-components
 
# read data
components_file_location <- "./inputs/housing_first_components.xlsx"
components_table <- readxl::read_excel(
  components_file_location,
  sheet = "components")

# produce table
components_table |>
  # add "@" in front of bibtex keys
  rename(
    "@kozloff2016housingfirsthomeless" = "kozloff2016housingfirsthomeless", 
    "@thulien2019evaluatingeffectsrent" = "thulien2019evaluatingeffectsrent", 
    "@slesnick2023housingsupportiveservices" = "slesnick2023housingsupportiveservices", 
    "@raithel2015partneringleveragemultiple" = "raithel2015partneringleveragemultiple",
    "@gilmer2016permanentsupportivehousing" = "gilmer2016permanentsupportivehousing"
    ) |>
  kbl(
    format = "html"
    ) |>
...
## Instruments used in included studies {#sec-instruments}

Instruments used to measure outcomes in included studies are detailed in @tbl-yh-instruments.

```{r}
#| echo: false
#| results: asis
#| tbl-cap: Instruments used in included studies
#| name: yh-supplementary-material-instruments
#| label: tbl-yh-instruments
 
# read data
instruments_file_location <- "./inputs/instruments.xlsx"
instruments_table <- readxl::read_excel(
  instruments_file_location,
  sheet = "instruments")
...
instruments_table |>
  mutate(
    Reference = str_c("@", Reference),
    `Included studies using instrument` = sapply(
      strsplit(`Included studies using instrument`, ";\\s*"), 
        function(x) {
  ...
  pack_rows(
    index = c(
      "Stable Housing" = 2, 
      "Health" = 9, 
      "Social and emotional wellbeing" = 5,
      "Employment and earnings" = 1,
      "Legal and justice" = 1,
      "Living skills and independence" = 2),
    label_row_css = "text-align: left; color: #FFFFFF; background-color: #E06632;"
    ) |>
  unclass() |> 
  cat()
...
## Risk of bias in included studies {#sec-risk-of-bias}
...
## Barriers and Facilitators {#sec-barriers-facilitators}

Barriers and facilitators grouped by EPIS domain are detailed in @tbl-yh-barriers-facilitators.

```{r}
#| echo: false
#| warning: false
#| results: asis
#| tbl-cap: Barriers and facilitators by EPIS domain
#| name: yh-supplementary-material-barriers-facilitators
#| label: tbl-yh-barriers-facilitators
 
# read data
barriers_facilitators_file_location <- "./inputs/barriers_facilitators.xlsx"
barriers_facilitators_table <- readxl::read_excel(
  barriers_facilitators_file_location,
  sheet = "barriers_facilitators",
  skip = 1) 

# rename columns to make them unique but meaningful
colnames(barriers_facilitators_table) <- c(
  "EPIS_domain",
  "Housing_inner",
  "Housing_outer",
  "Support_inner",
  "Support_outer",
  "Housing_Support_inner",
  "Housing_Support_outer"
)

# produce table
barriers_facilitators_table |>
  kbl(
    format = "html",
    col.names = c(
      "EPIS domain",
  ...
  add_header_above(
    header = c(
      ...
      "Support services components" = 2,
      "Housing and support service components" = 2
    )
  ) |>
  kable_styling(
