...
The PRISMA 2020 checklist [@page2021prisma2020statement] is included in @supptbl-yh-prisma-checklist.

::: {#supptbl-yh-prisma-checklist float="supptbl"}
```{r}
#| echo: false
#| results: asis
...
The databases and search terms are detailed in @supptbl-yh-review-search-terms below.
...
: Search terms {#supptbl-yh-review-search-terms} {tbl-colwidths="\[20,40,15,15\]"}

### Search strategy and results for grey sources

Sources and search terms used for grey sources are detailed in @supptbl-yh-review-grey-search below.

:::{#supptbl-yh-review-grey-search float="supptbl" tbl-colwidths="\[35,25,40\]"}
...
All reported measures corresponding to outcomes of interest at all available time points were extracted into a shared spreadsheet which is available in @supptbl-yh-instruments.
...
Components of interventions were classified based up on the definitions in @supptbl-yh-hf-components-def.
...
Additional reports of included studies, including protocols, implementation evaluations, and conference presentations, are detailed in @supptbl-yh-reports-included-studies.
...
Studies excluded at full-text review stage are detailed in @supptbl-yh-reports-excluded-studies, with a reason and rationale for their exclusion.
...
Details of Housing First components in included studies are detailed in @supptbl-yh-hf-components.
...
Instruments used to measure outcomes in included studies are detailed in @supptbl-yh-instruments.
...
Barriers and facilitators grouped by EPIS domain are detailed in @supptbl-yh-barriers-facilitators.
