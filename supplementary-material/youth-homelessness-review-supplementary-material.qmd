---
title: "Housing and Support Interventions for Homeless Youth in High-Income Countries: a Systematic Review — supplementary material"
author: 
  - name: David Taylor
...
format: 
  html: 
    ...
    #         text-align: center; font-size: 0.9em; z-index: 9999;
    #       }
    #       #cookie-banner button {
    #         background: #4CAF50; border: none; color: white;
    #         padding: 0.5em 1em; margin-left: 1em; border-radius: 4px;
    #         cursor: pointer;
    #       }
    #     </style>
    ...
    include-in-header: 
      text: |
        ...
        <style>
          ...
          #cookie-banner button {
            background: #4CAF50; border: none; color: white;
            padding: 0.5em 1em; margin: 0 0.3em; border-radius: 4px;
            cursor: pointer;
          }
        ...
        <div id="cookie-banner" style="display:none;">
          This site uses cookies for analytics to understand usage.
          <button id="accept-cookies">Accept</button>
        ...
        <script>
          (function() {
            ...
            function loadAnalytics() {
              ...
              gtagScript.src = 'https://www.googletagmanager.com/gtag/js?id=G-ZJMRY7KB31';
              document.head.appendChild(gtagScript);

              window.dataLayer = window.dataLayer || [];
              function gtag(){dataLayer.push(arguments);}
              gtag('js', new Date());
              gtag('config', 'G-ZJMRY7KB31', { 'anonymize_ip': true });
            }
...
-   [*SWiM Checklist*](#sec-swim-checklist) --- includes details of how this review meets the SWiM reporting guidelines
...
The PRISMA 2020 checklist [@page2021prisma2020statement] is included in @supptbl-yh-review-prisma-checklist.

::: {#supptbl-yh-review-prisma-checklist float="supptbl"}
```{r}
#| echo: false
#| results: asis
...
## SWiM Checklist {#sec-swim-checklist}

The Synthesis Without Meta-analysis (SWiM) checklist [@campbell2020synthesismetaanalysisswim] is included in @supptbl-yh-review-swim-checklist.

::: {#supptbl-yh-review-swim-checklist float="supptbl"}
```{r}
#| echo: false
#| results: asis
 
# read data
swim_file_location <- "./inputs/swim_checklist.xlsx"
swim_table <- readxl::read_excel(
  swim_file_location,
  sheet = "swim")
...
::: {#supptbl-yh-review-search-terms float="supptbl" tbl-colwidths="[20,40,15,15]"}
+-------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------+-----------+
...
The template in @supptbl-yh-review-de-study-level was used to extract information about the study.

:::: {#supptbl-yh-review-de-study-level float="supptbl"}
...
The template in @supptbl-yh-review-de-outcome-level was used to extract information about reported outcomes that would allow us to transform each of the reported results into a common effect size.

:::: {#supptbl-yh-review-de-outcome-level float="supptbl"}
...
In most cases, formulas from @borenstein2009introductionmetaanalysis were used to convert reported results into a common effect size (Hedges' *g*). This was done using the R Project for Statistical Computing [@rcoreteam2025languageenvironmentstatistical], and specifically the *esc* package [@ludecke2019esceffectsize].
...
::: {#supptbl-yh-reports-excluded-studies float="supptbl"}
```{r}
#| echo: false
#| results: asis
...
::: {#supptbl-yh-hf-components float="supptbl"}
```{r}
#| echo: false
#| results: asis
...
::: {#supptbl-yh-instruments float="supptbl"}
```{r}
#| echo: false
#| results: asis
...
For randomised controlled trials, we used the Cochrane Risk of Bias 2 tool to assess the risk of bias in all reported results @sterne2019robrevisedtool. The template and results are available in @supptbl-yh-review-rob2-template.

:::: {#supptbl-yh-review-rob2-template float="supptbl"}
...
For non-randomised studies of interventions, we used the ROBINS-I tool @sterne2016robinsitoolassessing. The template and results are available in @supptbl-yh-review-robins-i-template.

:::: {#supptbl-yh-review-robins-i-template float="supptbl"}
...
::: {#supptbl-yh-barriers-facilitators float="supptbl"}
```{r}
#| echo: false
#| warning: false
#| results: asis
