...
If the esc_type argument is set to 'g', the function also calculates Hedges' *g*, which applies Hedges' correction to an estimate of the standardised mean difference [@hedges1981distributiontheoryglasss]:
...
If the `esc_type` argument is set to 'g', the function also calculates Hedges' g, which is an unbiased estimate of the standardised mean difference [@hedges1981distributiontheoryglasss]:
...
For randomised controlled trials, we used the Cochrane Risk of Bias 2 tool to assess the risk of bias in all reported results @sterne2019rob2revised. The template and results are available in @supptbl-yh-review-rob2-template.
