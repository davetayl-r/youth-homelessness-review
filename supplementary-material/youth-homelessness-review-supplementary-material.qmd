...
-   *[Inclusion and exclusion criteria by PICOSS domain](#sec-inclusion-exclusion)* —- includes details of the criteria used to select studies eligible for inclusion in this review

-   *[Identification and selection of relevant studies](#sec-study-identification)* --- includes search strategies and results for each published database and grey sources

-   *[Extraction of information from relevant studies](#sec-data-extraction)* --- includes the template and information extracted from each included study used to transform into a common effect size

**Reported results and their transformation:**  
...
# Study identification and data extraction {#sec-inclusion-exclusion}

## Inclusion and exclusion criteria by PICOSS domain

Inclusion and exclusion criteria used in this review are detailed in @tbl-yh-review-picoss.
...
## Identification and selection of relevant studies {#sec-study-identification}
...
## Extraction of information from relevant studies {#sec-data-extraction}
