...
-   **Inclusion and exclusion criteria by PICOSS domain** —- includes details of the criteria used to select studies eligible for inclusion in this review
...
-   **Instruments used in included studies** --- includes details of the instuments used to assess outcomes for participants in included studies
...
-   **Extraction of information from relevant studies** --- includes the template and information extracted from each included study used to transform into a common effect size
...
# Housing First components of included interventions
